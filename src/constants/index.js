export const menu_info = [
    {
        id: 1,
        icon: "assets/sidebar/applications.svg",
        name: "Applications",
    },
    {
        id: 2,
        icon: "assets/sidebar/renewals.svg",
        name: "Renewals",
    },
    {
        id: 3,
...
export const settings_info = [
    {
        id: 1,
        icon: "assets/sidebar/integrations.svg",
        name: "Integrations",
    },
    {
        id: 2,
...
export const mc_engagement = [
    {
        ...
        btn: false,
        tag: "",
        detail: "Gather actionable insights off Zoom and stay aware of its user engagement and analyse spend",
    },
    {
        id: 2,
